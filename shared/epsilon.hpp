...
inline boost::int32_t ieee_floats_apart(float a, float b) {
  return unsigned_distance(
      reinterpret_cast<boost::uint32_t const&>(a),
...
inline boost::int64_t ieee_doubles_apart(double a, double b) {
  return unsigned_distance(
      reinterpret_cast<boost::uint64_t const&>(a),
...
*/
inline bool
few_ieee_floats_apart(float a, float b
...
inline bool
few_ieee_doubles_apart(double a, double b
...
inline bool
few_ieee_apart(float a, float b
               , boost::int32_t max_floats_apart = GRAEHL_DEFAULT_IEEE_APART) {
  return few_ieee_floats_apart(a, b, max_floats_apart);
}

inline bool
few_ieee_apart(double a, double b
               , boost::int64_t max_doubles_apart = GRAEHL_DEFAULT_IEEE_APART) {
...
template <class Float>
inline bool
within_epsilon(Float a, Float b, Float epsilon = (float)GRAEHL_EPSILON) {
  return std::fabs(a-b)<=epsilon;
}
...
*/
inline bool
within_epsilon_or_floats_apart(float a, float b
                               , float epsilon = (float)GRAEHL_EPSILON
                               , boost::int32_t max_floats_apart = GRAEHL_DEFAULT_IEEE_APART)
{
  return std::fabs(a-b)<=epsilon ||
...
*/
inline bool
within_epsilon_or_doubles_apart(double a, double b
                                , double epsilon = (double)GRAEHL_EPSILON
                                , boost::int64_t max_doubles_apart = GRAEHL_DEFAULT_IEEE_APART)
{
  return std::fabs(a-b)<=epsilon ||
...
*/
inline bool
within_epsilon_or_ieee_apart(float a, float b
                             , float epsilon = (float)GRAEHL_EPSILON)
{
...
*/
inline bool
within_epsilon_or_ieee_apart(double a, double b
                             , double epsilon = (double)GRAEHL_EPSILON)
{
